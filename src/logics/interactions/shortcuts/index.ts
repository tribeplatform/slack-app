...
import {
  getCreateTicketInteractionResponse,
  getCreateTicketShortcutStates,
} from './create-ticket'
...
export const getShortcutInteractionResponse = async (
  ...
  switch (shortcutKey) {
    case Shortcut.CreateTicket:
      return getCreateTicketInteractionResponse(webhook)
    default:
...
export const getShortcutStates = async (input: {
  ...
  switch (shortcut) {
    case Shortcut.CreateTicket:
      return getCreateTicketShortcutStates(options)
    default:
      return null
  }
}
